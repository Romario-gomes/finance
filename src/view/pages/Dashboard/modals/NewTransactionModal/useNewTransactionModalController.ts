...
export function useNewTransactionModalController() {
  ...
  const { handleSubmit: hookFormSubmit, register, formState: { errors }, control, reset } = useForm<FormData>({
  ...
  return {
    isNewTransactionModalOpen, closeNewTransactionModal, newTransactionType, register, errors, control, handleSubmit, accounts, categories, isPending
  }
}