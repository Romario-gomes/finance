    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button className={cn("rbg-white  w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-700  focus:border-gray-800 transition-all outline-none text-left relative",
            className,
